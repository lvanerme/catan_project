...
let virtual-env = "\\fileshare.cs.local\lvanerme\COS343\catan_project"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "\\fileshare.cs.local\lvanerme\COS343\catan_project\Scripts\deactivate.nu"
